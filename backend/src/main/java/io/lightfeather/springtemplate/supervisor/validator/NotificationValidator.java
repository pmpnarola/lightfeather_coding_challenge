package io.lightfeather.springtemplate.supervisor.validator;
...
public class NotificationValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return NotificationVo.class.equals(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        NotificationVo notificationReq = (NotificationVo) target;
