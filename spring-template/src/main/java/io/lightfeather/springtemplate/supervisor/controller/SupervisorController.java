package io.lightfeather.springtemplate.supervisor.controller;

import io.lightfeather.springtemplate.external.api.Manager;
import io.lightfeather.springtemplate.supervisor.dto.NotificationVo;
import io.lightfeather.springtemplate.supervisor.dto.ResponseVo;
import io.lightfeather.springtemplate.utility.Utility;
import io.lightfeather.springtemplate.external.api.ExternalAPI;
...
public class SupervisorController {
    ...
    @PostMapping("/submit")
    public ResponseEntity<ResponseVo> addNotification(@Validated @RequestBody NotificationVo notificationReq,
